...
const VolunteerInfo = () => {
  ...
  // Function to show organization form and hide individual form
  const showOrganizationOptions = () => {
    setShowOrganizationForm(true); // Show the organization form directly
    setShowIndividualForm(false);
  };

  // Popover content with information on how to volunteer
  const popover = (
  ...
  return (
    <div className="volunteering">
      <div className="volunteerBtns">
        ...
        {/* Offer a Volunteer Session button */}
        <button
        ...
        {/* Volunteer with an Organization button */}
        <button className="btn btn-primary" onClick={showOrganizationOptions}>
          Volunteer with an Organization
        </button>
      </div>

      {/* Render VolunteerSignUp component if showIndividualForm is true */}
      {showIndividualForm && (
        <VolunteerSignUp setShowForm={setShowIndividualForm} />
      )}

      {/* Render VolunteerOrg component if showOrganizationForm is true */}
